    ...
    <li class="nav-item">
        ...
        <div id="collapseWebsite" class="collapse" aria-labelledby="Websites">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/site/create">{{ __('Add') }} <i class="fas fa-plus-circle"></i></a>
            </div>
        </div>
    </li>
    <!-- Nav Item - Website Collapse Menu -->
    ...
    <li class="nav-item">
        ...
        <div id="collapseUser" class="collapse" aria-labelledby="collapseUser">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/user/create">{{ __('Create') }} <i class="fas fa-plus-circle"></i></a>
            </div>
        </div>
    </li>
    <!-- Nav Item - Users Collapse Menu -->
    ...
    <li class="nav-item">
        ...
        <div id="collapseDatabase" class="collapse" aria-labelledby="collapseDatabase">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="/database/create">{{ __('Create') }} <i class="fas fa-plus-circle"></i></a>
                <a class="collapse-item" href="/database/create-user">{{ __('Create user') }} <i class="fas fa-user-plus"></i></a>
            </div>
        </div>
    </li>
    <!-- Nav Item - Users Collapse Menu -->
